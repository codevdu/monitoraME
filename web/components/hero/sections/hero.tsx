	...
	return (
		<section className="mx-auto w-full max-w-5xl overflow-hidden pt-16">
			...
			<div className="relative z-10 flex max-w-2xl flex-col gap-5 px-4">
				<h1
					className={cn(
						"text-balance font-semibold text-4xl text-foreground leading-tight md:text-5xl",
				...
				>
					O MonitoraME organiza dados, registros e comunicações para apoiar
					equipes na rotina de acompanhamento e transparência.
				</p>

				<p
					className={cn(
						"max-w-xl text-muted-foreground text-xs leading-relaxed sm:text-sm",
						"fade-in slide-in-from-bottom-10 animate-in fill-mode-backwards delay-300 duration-500 ease-out"
					)}
				>
					A plataforma não substitui assessoria jurídica, decisão da autoridade
					pública competente, processo licitatório oficial ou publicação exigida
					por lei.
				</p>
			...
			<div className="relative">
				...
				>
					<div className="relative inset-shadow-2xs inset-shadow-foreground/10 mx-auto max-w-5xl overflow-hidden rounded-lg border bg-background p-2 shadow-xl ring-1 ring-card dark:inset-shadow-foreground/20 dark:inset-shadow-xs">
						<Image
							alt="Tela do painel de acompanhamento do MonitoraME"
