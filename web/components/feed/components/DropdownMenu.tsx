...
export function Filters() {
  ...
  return (
    <div ref={menuRef} className="relative inline-block">
      ...
      {open && (
        <div className="absolute left-0 top-full z-50 mt-1.5 w-64 overflow-hidden rounded-xl border border-border/60 bg-background p-1shadow-lg">
