...
<TooltipPrimitive.Arrow
  className={cn(
    ...
    "data-[side=bottom]:top-1 data-[side=left]:-right-3.25 data-[side=left]:top-1/2! data-[side=left]:-translate-y-1/2 data-[side=right]:-left-3.25 data-[side=right]:top-1/2! data-[side=right]:-translate-y-1/2 data-[side=top]:-bottom-2.5",
    className
  )}
/>
```
